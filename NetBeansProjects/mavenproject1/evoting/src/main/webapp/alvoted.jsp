                ...
                <!-- Data table -->
                  ...
                  <div class="card" style="width: 100%;">
                    <div class="card-header text-danger">
                        You have already voted for a Presidential Candidate!
                    </div>
                      <div class="card-body">
                          <h5 class="text-info" style="text-decoration: underline;">Presidential Voting:</h5><br/><hr/>
                          
                          <span>Student with ID <%= request.getParameter("id")%> has already voted in the
                              the Presidential Elections. <br/> You therefore cannot Vote Again
                          </span><br/>
                              <div><hr/>
