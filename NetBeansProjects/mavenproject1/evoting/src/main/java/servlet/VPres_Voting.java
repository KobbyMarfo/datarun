 ...
 * @author apple
 */
public class VPres_Voting extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            PreparedStatement ps1 = conn.prepareStatement("Insert into vice_presidential (voter_id,candidate_id,create_time) values (?,?,?)");
            ps1.setString(1, id);
            ...
            if(result1 != 0){
               ...
               response.sendRedirect("voting.jsp?");
                ...
                response.sendRedirect("failed2.jsp?id="+id);
                System.out.println("failed2.jsp?id="+id);
            }
            conn.close();
            ...
            if(ex.getErrorCode()==1062){
                response.sendRedirect("alvoted_1.jsp?id="+id);
            }
